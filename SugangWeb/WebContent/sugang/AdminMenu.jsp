...
<body>
<div class="col">
<div class="item1"><div id="title"><h1>관리자 메뉴</h1></div></div>
<div class="row1">
	<div class="item2"> <div id=center> 사용자 등록 </div>
		<div class="submenu">
			<a href="CreateProfForm.jsp" target = "f3">교수등록</a>
			<a href="CreateStuForm.jsp" target = "f3">학생등록</a>
		</div>		
	</div>
	<div class="item2"> <div id=center> 사용자 수정 </div>
		<div class="submenu">
			<a href="UpdateProfForm.jsp" target = "f3">교수수정</a>
			<a href="UpdateStuForm.jsp" target = "f3">학생수정</a>
		</div>		
	</div>
	<div class="item2"> <div id=center>관리메뉴</div>
		<div class="submenu">
			<a href="CloseLecForm.jsp" target = "f3">미달인원<br>강의폐강 </a>
			<a href="ReadLectBackup.jsp" target = "f3">수정정보확인</a>
		</div>
	</div>
	<div id ="blank"></div>
	<div id="login">
